...
<body>
    <div class="wrapper">
	    ...
	    <c:if test="${error != null}">
	    	<div class="message-error">
	    		Register failed, reason: ${error}
	    	</div>
	    </c:if>
        <form:form class="login text-center" action="${contextPath}/auth/DangKyAction" method="post" id="register-form">
            <p class="title">Đăng ký</p>
            <div class="form-group">
	            <form:input path="tenHocSinh" placeholder="Họ tên" autofocus="autofocus" required="required"/>
	            <i class="fa fa-user"></i> 
            </div>
            <div class="form-group">
	            <form:input path="username" placeholder="Tài khoản" required="required"/>
	            <i class="fa fa-user"></i> 
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
	            <input type="password" name="password_confirm" placeholder="Xác nhận mật khẩu" required="required" oninput="check(this)"/>
	            <i class="fa fa-key"></i>
            </div>
            <button type="submit">
